...
main(int argc, char ** argv) 
{
  ...
  12:	19e080e7          	jalr	414(ra) # 1ac <atoi>
  16:	00000097          	auipc	ra,0x0
  1a:	33e080e7          	jalr	830(ra) # 354 <trace>

  exec(argv[2], argv + 2);
  1e:	01048593          	addi	a1,s1,16
  22:	6888                	ld	a0,16(s1)
  24:	00000097          	auipc	ra,0x0
  28:	2c0080e7          	jalr	704(ra) # 2e4 <exec>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3a4:	44050513          	addi	a0,a0,1088 # 7e0 <digits>
 3a8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 470:	374b8b93          	addi	s7,s7,884 # 7e0 <digits>
 ...
 5b0:	22c90913          	addi	s2,s2,556 # 7d8 <malloc+0xe6>
        while(*s != 0){
...
free(void *ap)
{
 ...
 678:	1847b783          	ld	a5,388(a5) # 7f8 <freep>
 ...
 6a6:	00e6ea63          	bltu	a3,a4,6ba <free+0x50>
{
 ...
 6e8:	10f73a23          	sd	a5,276(a4) # 7f8 <freep>
}
 6ec:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 71a:	0e253503          	ld	a0,226(a0) # 7f8 <freep>
 ...
 742:	0ba90913          	addi	s2,s2,186 # 7f8 <freep>
  if(p == (char*)-1)
 746:	5afd                	li	s5,-1
 748:	a88d                	j	7ba <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 74a:	00000797          	auipc	a5,0x0
 74e:	0b678793          	addi	a5,a5,182 # 800 <base>
 752:	00000717          	auipc	a4,0x0
 756:	0af73323          	sd	a5,166(a4) # 7f8 <freep>
 75a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 77c:	08a73023          	sd	a0,128(a4) # 7f8 <freep>
      return (void*)(p + 1);
